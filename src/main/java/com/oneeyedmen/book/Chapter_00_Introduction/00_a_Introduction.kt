...
/*-
This is not a book to teach you programming. It assumes that you have already mastered the basics, consider yourself an accomplished developer, but want to improve. Frankly I’m in the same boat. My aim is to write the book that I wished I’d read 5 years ago, one that discusses software development in the way that we might if we bumped into each other at a conference, or paired on some code for a client.
