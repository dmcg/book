...
object Translator {
    ...
    fun translate(source: String): Sequence<String> {
        val blocks: List<Block> = runner.run(source).valueStack.toList().asReversed()
        return blocks.flatMap { it.render() }.asSequence()
    }
}
//`
