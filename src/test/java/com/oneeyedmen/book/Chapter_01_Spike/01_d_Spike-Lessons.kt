...
Secondly, I'm trying to demonstrate risk reduction - making sure that I don't commit too much effort into a doomed
 ...
 on tooling to produce the book before I'm finished - the code is rough and the inability to write about my own notation
 without invoking it is a shame - but right now we have confidence without too much cost.
