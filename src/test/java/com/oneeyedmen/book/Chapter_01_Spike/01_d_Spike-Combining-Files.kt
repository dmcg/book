...
/*-
Looking back at the last version of the `translate` function you'll see that I have changed to taking a list of Strings and returning a Sequence - this will allow me to avoid having all the text of all files in memory. I've also put `null`s into that Sequence where we are skipping a line - that makes it easy for the caller to recognise them.
